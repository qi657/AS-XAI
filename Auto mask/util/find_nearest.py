...
from TES_github.util.receptive_field import compute_rf_prototype
from TES_github.util.helpers import makedir, find_high_activation_crop
...
def find_k_nearest_patches_to_prototypes(dataloader, # pytorch dataloader (must be unnormalized in [0,1])
    ...
    for idx, (search_batch_input, search_y) in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            protoL_input_torch, proto_dist_torch, _ = \
